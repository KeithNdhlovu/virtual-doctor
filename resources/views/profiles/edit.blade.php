                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                <li><a href="javascript:void(0);">{{ trans('profile.editProfileTitle') }}</a></li>
                                <li><a href="javascript:void(0);">{{ trans('profile.editAccountTitle') }}</a></li>
                                <li><a href="javascript:void(0);">{{ trans('profile.editAccountAdminTitle') }}</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
